...
int main() {
    ...
    $test_qes(solve_quadratic_equation(0,  -7, 0.5, x1, x2), 1,  0.5 / 7, 0);

    $test_qes(solve_quadratic_equation(0,  0, -25, x1, x2), 0,  0, 0);
    $test_qes(solve_quadratic_equation(0,  0, 0.2, x1, x2), 0,  0, 0);
